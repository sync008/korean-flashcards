...
const flashcardData = {
    ...
    "Verbs 1": [
        ...
        { korean: "만들다", romanization: "mandeulda", meaning: "to make (irregular ㄹ)" },
        { korean: "하다", romanization: "hada", meaning: "to do" },
        { korean: "끄다", romanization: "kkeuda", meaning: "to turn off (irregular ㅡ)" },
        { korean: "닫다", romanization: "datda", meaning: "to close (regular ㄷ)" },
        { korean: "열다", romanization: "yeolda", meaning: "to open (irregular ㄹ)" },
        { korean: "쓰다", romanization: "sseuda", meaning: "to use (irregular ㅡ)" },
        ...
        { korean: "썰다", romanization: "sseolda", meaning: "to chop (irregular ㄹ)" },
        { korean: "갈다", romanization: "galda", meaning: "to sharpen (blade) (irregular ㄹ)" },
        { korean: "매다", romanization: "maeda", meaning: "to tie" },
        { korean: "밀다", romanization: "milda", meaning: "to push (irregular ㄹ)" },
        { korean: "끌다", romanization: "kkeulda", meaning: "to pull/drag (irregular ㄹ)" },
        { korean: "나르다", romanization: "nareuda", meaning: "to carry (irregular 르)" },
        { korean: "뽑다", romanization: "ppopda", meaning: "to unplug" },
        { korean: "걸다", romanization: "geolda", meaning: "to hang (irregular ㄹ)" },
        { korean: "오다", romanization: "oda", meaning: "to come" },
        { korean: "가다", romanization: "gada", meaning: "to go" },
        { korean: "들다", romanization: "deulda", meaning: "to enter (irregular ㄹ)" },
        ...
        { korean: "읽다", romanization: "ikda", meaning: "to read (regular)" },
    ],
    ...
    "Verbs 2": [
        ...
        { korean: "팔다", romanization: "palda", meaning: "to sell (irregular ㄹ)" },
        ...
        { korean: "널다", romanization: "neolda", meaning: "to hang up/to dry out (laundry) (irregular ㄹ)" },
        { korean: "담그다", romanization: "damgeuda", meaning: "to soak" },
        { korean: "오르다", romanization: "oreuda", meaning: "to ascend (irregular ㅡ)" },
        { korean: "올라오다", romanization: "ollaoda", meaning: "to come up" },
        { korean: "돌아오다", romanization: "doraoda", meaning: "to come back" },
        { korean: "기르다", romanization: "gireuda", meaning: "to raise/grow (irregular 르)" },
        ...
        { korean: "고프다", romanization: "gopeuda", meaning: "to be hungry (irregular ㅡ)" },
        { korean: "기쁘다", romanization: "gippeuda", meaning: "to be please (irregular ㅡ)" },
        { korean: "바쁘다", romanization: "bappeuda", meaning: "to be busy (irregular ㅡ)" },
        { korean: "크다", romanization: "keuda", meaning: "to be big (irregular ㅡ)" },
        { korean: "나쁘다", romanization: "nappeuda", meaning: "to be bad (irregular ㅡ)" },
        { korean: "다르다", romanization: "dareuda", meaning: "to be different (irregular ㅡ)" },
        { korean: "빠르다", romanization: "ppareuda", meaning: "to be fast (irregular ㅡ)" },
        { korean: "마르다", romanization: "mareuda", meaning: "to be dry (irregular 르)" },
        { korean: "이르다", romanization: "ireuda", meaning: "to be early (irregular 르)" },
        { korean: "흐르다", romanization: "heureuda", meaning: "to flow (irregular 르)" },
