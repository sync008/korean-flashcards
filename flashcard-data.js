...
const flashcardData = {
    ...
    "Government and Public Offices": [
        { korean: "관공서", romanization: "gwangongseo", meaning: "Government And Public Offices" },
        ...
        { korean: "출입국관리사무소", romanization: "churipguk gwalli samusso", meaning: "Immigration Office" },
    ...
    "Occupations": [
        { korean: "직업", romanization: "jigeop", meaning: "Occupations" },
    ...
    "Greetings": [
        { korean: "인사", romanization: "insa", meaning: "Greetings" },
    ...
    "Daily Routine": [
        { korean: "일과", romanization: "ilgwa", meaning: "The Daily Routine" },
    ...
    "Range of Hours": [
        { korean: "시간", romanization: "sigan", meaning: "Range Of Hours" },
    ...
    "Looks and Personality": [
        { korean: "외모와 성격", romanization: "oimowa seonggyeok", meaning: "Looks And Personality" },
    ...
    "Money and Purchasing Goods": [
        { korean: "화폐와 물품구매", romanization: "hwapyewa mulpum gumae", meaning: "Money And Purchasing Goods" },
    ...
    "Locomotive Verbs": [
        { korean: "이동 동사", romanization: "idong dongsa", meaning: "Locomotive Verbs" },
    ...
    "Signs": [
        { korean: "표지판", romanization: "pyojipan", meaning: "Signs" },
    ...
    "Locations and Directions": [
        { korean: "위치와 방향", romanization: "wichiwa banghyang", meaning: "Locations And Directions" },
    ...
    "Streets": [
        { korean: "길거리", romanization: "gilgeori", meaning: "Streets" },
    ...
    "Stative Verb 1": [
        { korean: "상태 1", romanization: "sangtae 1", meaning: "Stative Verb 1" },
    ...
    "Stative Verb 2": [
        { korean: "상태 2", romanization: "sangtae 2", meaning: "Stative Verb 2" },
    ...
    "Taste of Foods": [
        { korean: "음식의 맛", romanization: "eumsigui mat", meaning: "Taste Of Foods" },
    ...
    "Weather and Seasons": [
        { korean: "날씨와 계절", romanization: "nalssowa gyejeol", meaning: "weather and seasons" },
    ...
    "Adverbs": [
        { korean: "부사", romanization: "busa", meaning: "Adverbs" },
    ...
    "Feelings and Moods": [
        { korean: "기분", romanization: "gibun", meaning: "Feelings and Moods" },
    ...
    "Adverbs of Frequency": [
        { korean: "빈도 부사", romanization: "bindo busa", meaning: "Adverbs Of Frequency" },
    ...
    "Hobbies": [
        { korean: "취미", romanization: "chwimi", meaning: "Hobbies" },
    ...
    "Clubs for People with Shared Interests": [
        { korean: "동호회", romanization: "dongho-hoe", meaning: "Clubs for people with shared interests" },
    ...
    "Sports": [
        { korean: "운동", romanization: "undong", meaning: "Sports" },
